...
async def sign_app(page: ft.Page):
    ...
    async def yes_smena_password(e):
        ...
        async def smena_password(e):
            try:
                ...
                print(f'Error in module "smena_password": {ex}')
        ...
        async def smena_password_2(e):
            try:
                ...
                print(f'Error in module "smena_password_2": {ex}')
        ...
        async def smena_password_3(e):
            try:
                ...
                print(f'Error in module "smena_password_3": {ex}')
        ...
        async def smena_password_4(e):
            try:
                ...
                print(f'Error in module "smena_password_4": {ex}')
        ...
        async def smena_password_5(e):
            try:
                ...
                print(f'Error in module "smena_password_5": {ex}')
        ...
        async def smena_password_6(e):
            try:
                ...
                print(f'Error in module "smena_password_6": {ex}')
    ...
    async def sign_in(e):
        ...
        async def sign_in_3(e):
            try:
                ...
                print(f'Error in module "sign_in_3" - {ex}')
        ...
        async def sign_in_4(e):
            try:
                ...
                print(f'Error in module "sign_in_4": {ex}')
        ...
        async def sign_in_5(e):
            try:
                ...
                print(f'Error in module "sign_in_5": {ex}')
        ...
        async def sign_in_6(e):
            try:
                ...
                print(f'Error in module "sign_in_6": {ex}')
        ...
        try:
            ...
            print(f'Error in module "sign_in": {ex}')
    ...
    async def log_in(e):
        ...
        async def log_in_3(e, identificator="False", login="False", password="False"):
            try:
                ...
                print(f'Error in module "log_in_3" - {ex}')
        ...
        try:
            ...
            print(f'Error in module "log_in" - {ex}')
    ...
    async def no_ethernet(e):
        ...
        try:
            ...
            print(f'Error in module "no_ethernet" - {ex}')
    ...
    try:
        ...
        print(f'Error in module "main" - {ex}')
